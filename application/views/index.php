...
<head>
    ...
    <!--[if lt IE 9]>
      ...
      <body>
      		...
      		<div class="container">
      			...
      			<div class="navbar-collapse collapse navbar-right scroll-me">
      				<ul class="nav navbar-nav ">
      					...
      					<li><a href="#services">PRO DTAC</a></li>
      					<li><a href="#works">PRO 1-2-call</a></li>
      					<li><a href="#contact">RPO TRUE MOVE</a></li>
      				</ul>
      			</div>
      		...
      		<div class="overlay">
      			...
      			<div class="container">
      				...
      				<div class="col-md-8 col-md-offset-2 text-center">
      					...
      					<!-- <h1>DESIGN AGENCY </h1> -->
      					<p><h2>ขอบคุณที่ไว้วางใจให้เราดูแล</h2></p>
      					<p class="p-cls">
      						........................................................
      					</p>
      				</div>
      	...
      	<!--HOME SECTION END  -->
      	<section id="services" style="background-color: #81DAF5;">
      		<div class="container" style="background-color: #fff;">
      			<div class="row text-center pad-bottom">
      				<div class="col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3">
      					<h2 class="head-set">โปรเสริม DTAC</h2>
      					<p>
      	...
      	<section id="works" style="background-color: #81F781;">
      		<div class="container" style="background-color: #fff;">
      			<div class="row text-center pad-bottom">
      				<div class="col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3">
      	...
      	<section id="clients">
      		<div class="container">
      			<div class="row">
      				<div class="col-md-3">
      					<img src="<?php echo base_url(); ?>assets/img/audio.png" alt="" class="img-responsive" />
      				</div>
      				<div class="col-md-3">
      					<img src="<?php echo base_url(); ?>assets/img/codecanon.png" alt="" class="img-responsive" />
      				</div>
      				<div class="col-md-3">
      					<img src="<?php echo base_url(); ?>assets/img/graphic.png" alt="" class="img-responsive" />
      				</div>
      				<div class="col-md-3">
      					<img src="<?php echo base_url(); ?>assets/img/themeforest.png" alt="" class="img-responsive" />
      				</div>
      			</div>
